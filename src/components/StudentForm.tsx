...
//
//   return (
//       <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-sm">
//         {step === 1 && (
//             <div>
//               <Label htmlFor="Sexe">Sexe</Label>
//               <select id="Sexe" name="Sexe" value={formData.Sexe} onChange={handleChange} className="w-full p-2 border rounded">
//                 <option value="M">Masculin</option>
//                 <option value="F">Féminin</option>
//               </select>
//               <Label htmlFor="Série">Série</Label>
//               <select id="Série" name="Série" value={formData.Série} onChange={handleChange} className="w-full p-2 border rounded">
//                 <option value="S1">S1</option>
//                 <option value="S2">S2</option>
//                 <option value="S3">S3</option>
//               </select>
...
//             <div>
//               <Label htmlFor="MATH">Note en Mathématiques</Label>
//               <Input type="number" step="0.5" id="MATH" name="MATH" value={formData.MATH} onChange={handleChange} />
//               <Label htmlFor="SCPH">Note en Sciences Physiques</Label>
//               <Input type="number" step="0.5" id="SCPH" name="SCPH" value={formData.SCPH} onChange={handleChange} />
//             </div>
//         )}
//
//         {step === 3 && (
//             <div>
//               <Label htmlFor="Mention">Mention</Label>
//               <select id="Mention" name="Mention" value={formData.Mention} onChange={handleChange} className="w-full p-2 border rounded">
//                 <option value="Passable">Passable</option>
//                 <option value="Assez Bien">Assez Bien</option>
//                 <option value="Bien">Bien</option>
//                 <option value="Très Bien">Très Bien</option>
...
//           {step > 1 && <Button type="button" onClick={handlePrev} className="bg-gray-300">Précédent</Button>}
//           {step < totalSteps ? (
//               <Button type="button" onClick={handleNext} className="bg-primary text-white">Suivant</Button>
//           ) : (
//               <Button type="submit" className="bg-green-500 text-white">Soumettre</Button>
//           )}
//         </div>
//       </form>
//   );
...
//
//           <div className="space-y-2">
//             <Label htmlFor="Moy_Gle">Moyenne Générale (calculée automatiquement)</Label>
//             <Input
//                 type="number"
//                 id="Moy_Gle"
//                 name="Moy_Gle"
...
//
//           <div className="space-y-2">
//             <Label htmlFor="Moy_sur_Mat_Fond">Moyenne Matières Fondamentales (calculée automatiquement)</Label>
//             <Input
//                 type="number"
//                 id="Moy_sur_Mat_Fond"
//                 name="Moy_sur_Mat_Fond"
...
//
//           <div className="space-y-2">
//             <Label htmlFor="Moyenne_au_Grp">Moyenne au Groupe (calculée automatiquement)</Label>
//             <Input
//                 type="number"
//                 id="Moyenne_au_Grp"
//                 name="Moyenne_au_Grp"
